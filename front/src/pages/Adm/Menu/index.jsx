  ...
  return (
    <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0">
      ...
      <nav className="p-4 space-y-2 flex-1 overflow-y-auto">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/><path d="M12 2v4"/><path d="M12 18v4"/></svg>
          Histórico
        </NavLink>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M17.5 17.5 14 14"/><path d="M3 3v18h18"/><path d="m14 9 3-3 3 3"/><path d="M3 14h4v4h4v-4h4v-4H7Z"/></svg>
          Relatórios
        </NavLink>     
      </nav>
      ...
      <div className="p-4 border-t border-slate-200 shrink-0">
        ...
        <button onClick={logout} className="w-full flex items-center justify-center gap-2 text-sm bg-red-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-red-600 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>
          Sair
        </button>
      </div>
    </aside>
